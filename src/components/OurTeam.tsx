...
const roles = ["Founder", "Co-Founder", "Operational Manager"];
    ...
    <section className="relative min-h-screen bg-gray-900 px-4 py-20 bg-blend-color-burn">
      ...
      <div className="container relative mx-auto max-w-7xl px-4 py-20 md:px-8">
        <div className="mb-16 space-y-12 text-center">
          <div space-y-4>
            <h2 className="bg-gradient-to-r from-amber-200 to-amber-400 bg-clip-text text-3xl font-bold text-transparent md:text-6xl">
              Meet the Passionate Minds Behind Our Coffee Journey
            </h2>
            <p className="mt-8 text-lg text-gray-400">
              Get to know the founders and team brewing excellence in every cup.
            </p>
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center">
          <button className="ml-auto transform rounded-lg bg-amber-500 px-8 py-4 font-semibold text-gray-900 transition duration-200 hover:scale-105 hover:bg-amber-600 hover:shadow-xl">
            <Link href="/team">See All Teams</Link>
          </button>
        </div>
      </div>
    </section>
